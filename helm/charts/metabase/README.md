...
This version of the chart has been based on the below. We do not currently publish our charts to a Helm Repository.
...
| persistence.enabled              | When enabled a new PV/PVC will be used for the h2 db        | true              |
| persistence.mountPath            | The mountpath for the PV                                    | /metabase-data    |
| persistence.existingClaim        | A manually managed PVC                                      | null              |
| persistence.subPath              | The subdirectory of the volume to mount to                  | ""                |
| persistence.storageClass         | The PV storage class to use                                 | null              |
| persistence.accessModes          | List of PV access modes                                     | [ReadWriteOnce]   |
| persistence.size                 | Size of the PV                                              | 8Gi               |
| persistence.annotations          | Annotations to be applied to the PVC                        | {}                |
| persistence.selector             | Selector can be used to match an existing PV                | {}                |
